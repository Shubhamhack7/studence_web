...
class StudenceSimpleEventModel extends GenericWidgetManeger {
  late final StudenceRouteEnum pageEnum;
  late final String id;

  StudenceSimpleEventModel(StudenceRouteEnum pageEnum, String widgetId)
      : super(
            pageEnum,
            widgetId,
  ...
  SimpleModel<EventHandler, ListenerProvider<EventHandler>>
      getEventWidgetModel() {
    return getEventWidgetInfoInMap(pageEnum, id, ModelTypeEnum.EVENT_MODEL);
  }
}
