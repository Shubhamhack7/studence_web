...
class StudenceSimpleTextInputModel extends GenericWidgetManeger {
  late final StudenceRouteEnum pageEnum;
  late final String id;

  StudenceSimpleTextInputModel(StudenceRouteEnum pageEnum, String widgetId)
      : super(
            pageEnum,
            widgetId,
  ...
  StudenceTextBoxEditWidgetCntroller getTextINputWidgetModel() {
    return getTextInputWidgetInfoInMap(pageEnum, id, ModelTypeEnum.TEXT_MODEL);
  }
}
