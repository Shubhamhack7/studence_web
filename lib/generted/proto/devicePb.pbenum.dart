...
class DeviceIPAddressType extends $pb.ProtobufEnum {
  static const DeviceIPAddressType UNKNOWN_IPADDRESS_TYPE = DeviceIPAddressType._(0, _omitEnumNames ? '' : 'UNKNOWN_IPADDRESS_TYPE');
  static const DeviceIPAddressType IPV4 = DeviceIPAddressType._(1, _omitEnumNames ? '' : 'IPV4');
  static const DeviceIPAddressType IPV6 = DeviceIPAddressType._(2, _omitEnumNames ? '' : 'IPV6');

  static const $core.List<DeviceIPAddressType> values = <DeviceIPAddressType> [
    UNKNOWN_IPADDRESS_TYPE,
    IPV4,
    IPV6,
  ];

  static final $core.Map<$core.int, DeviceIPAddressType> _byValue = $pb.ProtobufEnum.initByValue(values);
