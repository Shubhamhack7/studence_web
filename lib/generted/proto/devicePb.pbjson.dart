...
@$core.Deprecated('Use deviceIPAddressTypeDescriptor instead')
const DeviceIPAddressType$json = {
  '1': 'DeviceIPAddressType',
  '2': [
    {'1': 'UNKNOWN_IPADDRESS_TYPE', '2': 0},
    {'1': 'IPV4', '2': 1},
    {'1': 'IPV6', '2': 2},
  ],
};

/// Descriptor for `DeviceIPAddressType`. Decode as a `google.protobuf.EnumDescriptorProto`.
...
const AndroidDisplayInfo$json = {
  ...
  '2': [
    {'1': 'display_size_inches', '3': 1, '4': 1, '5': 2, '10': 'displaySizeInches'},
    {'1': 'display_width_pixels', '3': 2, '4': 1, '5': 5, '10': 'displayWidthPixels'},
    {'1': 'display_width_inches', '3': 3, '4': 1, '5': 2, '10': 'displayWidthInches'},
    {'1': 'display_height_pixels', '3': 4, '4': 1, '5': 5, '10': 'displayHeightPixels'},
    {'1': 'display_height_inches', '3': 5, '4': 1, '5': 2, '10': 'displayHeightInches'},
    {'1': 'display_x_dpi', '3': 6, '4': 1, '5': 2, '10': 'displayXDpi'},
    {'1': 'display_y_dpi', '3': 7, '4': 1, '5': 2, '10': 'displayYDpi'},
  ],
};
...
final $typed_data.Uint8List androidDisplayInfoDescriptor = $convert.base64Decode(
    ...
    'xheVNpemVJbmNoZXMSMAoUZGlzcGxheV93aWR0aF9waXhlbHMYAiABKAVSEmRpc3BsYXlXaWR0'
    ...
    'ChVkaXNwbGF5X2hlaWdodF9pbmNoZXMYBSABKAJSE2Rpc3BsYXlIZWlnaHRJbmNoZXMSIgoNZG'
...
@$core.Deprecated('Use deviceIpAddressDescriptor instead')
const DeviceIpAddress$json = {
  '1': 'DeviceIpAddress',
  '2': [
    {'1': 'deviceIpAddress', '3': 1, '4': 1, '5': 9, '10': 'deviceIpAddress'},
    {'1': 'ipType', '3': 2, '4': 1, '5': 14, '6': '.proto.DeviceIPAddressType', '10': 'ipType'},
  ],
};

/// Descriptor for `DeviceIpAddress`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deviceIpAddressDescriptor = $convert.base64Decode(
    'Cg9EZXZpY2VJcEFkZHJlc3MSKAoPZGV2aWNlSXBBZGRyZXNzGAEgASgJUg9kZXZpY2VJcEFkZH'
    'Jlc3MSMgoGaXBUeXBlGAIgASgOMhoucHJvdG8uRGV2aWNlSVBBZGRyZXNzVHlwZVIGaXBUeXBl');

@$core.Deprecated('Use deviceDetailsPbDescriptor instead')
const DeviceDetailsPb$json = {
  '1': 'DeviceDetailsPb',
  '2': [
    {'1': 'dbInfo', '3': 1, '4': 1, '5': 11, '6': '.proto.EntityPb', '10': 'dbInfo'},
    {'1': 'deviceOsType', '3': 2, '4': 1, '5': 14, '6': '.proto.DeviceOSTypeEnum', '10': 'deviceOsType'},
    {'1': 'androidDevice', '3': 3, '4': 1, '5': 11, '6': '.proto.AndroidDeviceDetails', '10': 'androidDevice'},
    {'1': 'iosDevice', '3': 4, '4': 1, '5': 11, '6': '.proto.IOSDeviceDetails', '10': 'iosDevice'},
    {'1': 'windowsDevice', '3': 5, '4': 1, '5': 11, '6': '.proto.WindowsDeviceDetails', '10': 'windowsDevice'},
    {'1': 'macOsDevice', '3': 6, '4': 1, '5': 11, '6': '.proto.MacOSDeviceDetails', '10': 'macOsDevice'},
    {'1': 'webBrowserDevice', '3': 7, '4': 1, '5': 11, '6': '.proto.WebBrowserInfoDetails', '10': 'webBrowserDevice'},
    {'1': 'linuxDevice', '3': 8, '4': 1, '5': 11, '6': '.proto.LinuxDeviceInfoDetails', '10': 'linuxDevice'},
    {'1': 'screeSize', '3': 9, '4': 1, '5': 11, '6': '.proto.DeviceScreenSize', '10': 'screeSize'},
    {'1': 'deviceMacId', '3': 10, '4': 1, '5': 9, '10': 'deviceMacId'},
    {'1': 'deviceIpAddress', '3': 11, '4': 1, '5': 11, '6': '.proto.DeviceIpAddress', '10': 'deviceIpAddress'},
    {'1': 'unique_id', '3': 12, '4': 1, '5': 9, '10': 'uniqueId'},
    {'1': 'mode', '3': 13, '4': 1, '5': 14, '6': '.proto.DeviceAppMode', '10': 'mode'},
    {'1': 'deviceType', '3': 14, '4': 1, '5': 14, '6': '.proto.DeviceTypeEnum', '10': 'deviceType'},
    {'1': 'pushNotificationRef', '3': 15, '4': 1, '5': 11, '6': '.proto.PushNotificationRefPb', '10': 'pushNotificationRef'},
    {'1': 'device_id', '3': 16, '4': 1, '5': 9, '10': 'deviceId'},
  ],
};

/// Descriptor for `DeviceDetailsPb`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deviceDetailsPbDescriptor = $convert.base64Decode(
    'Cg9EZXZpY2VEZXRhaWxzUGISJwoGZGJJbmZvGAEgASgLMg8ucHJvdG8uRW50aXR5UGJSBmRiSW'
    '5mbxI7CgxkZXZpY2VPc1R5cGUYAiABKA4yFy5wcm90by5EZXZpY2VPU1R5cGVFbnVtUgxkZXZp'
    'Y2VPc1R5cGUSQQoNYW5kcm9pZERldmljZRgDIAEoCzIbLnByb3RvLkFuZHJvaWREZXZpY2VEZX'
    'RhaWxzUg1hbmRyb2lkRGV2aWNlEjUKCWlvc0RldmljZRgEIAEoCzIXLnByb3RvLklPU0Rldmlj'
    'ZURldGFpbHNSCWlvc0RldmljZRJBCg13aW5kb3dzRGV2aWNlGAUgASgLMhsucHJvdG8uV2luZG'
    '93c0RldmljZURldGFpbHNSDXdpbmRvd3NEZXZpY2USOwoLbWFjT3NEZXZpY2UYBiABKAsyGS5w'
    'cm90by5NYWNPU0RldmljZURldGFpbHNSC21hY09zRGV2aWNlEkgKEHdlYkJyb3dzZXJEZXZpY2'
    'UYByABKAsyHC5wcm90by5XZWJCcm93c2VySW5mb0RldGFpbHNSEHdlYkJyb3dzZXJEZXZpY2US'
    'PwoLbGludXhEZXZpY2UYCCABKAsyHS5wcm90by5MaW51eERldmljZUluZm9EZXRhaWxzUgtsaW'
    '51eERldmljZRI1CglzY3JlZVNpemUYCSABKAsyFy5wcm90by5EZXZpY2VTY3JlZW5TaXplUglz'
    'Y3JlZVNpemUSIAoLZGV2aWNlTWFjSWQYCiABKAlSC2RldmljZU1hY0lkEkAKD2RldmljZUlwQW'
    'RkcmVzcxgLIAEoCzIWLnByb3RvLkRldmljZUlwQWRkcmVzc1IPZGV2aWNlSXBBZGRyZXNzEhsK'
    'CXVuaXF1ZV9pZBgMIAEoCVIIdW5pcXVlSWQSKAoEbW9kZRgNIAEoDjIULnByb3RvLkRldmljZU'
    'FwcE1vZGVSBG1vZGUSNQoKZGV2aWNlVHlwZRgOIAEoDjIVLnByb3RvLkRldmljZVR5cGVFbnVt'
    'UgpkZXZpY2VUeXBlEk4KE3B1c2hOb3RpZmljYXRpb25SZWYYDyABKAsyHC5wcm90by5QdXNoTm'
    '90aWZpY2F0aW9uUmVmUGJSE3B1c2hOb3RpZmljYXRpb25SZWYSGwoJZGV2aWNlX2lkGBAgASgJ'
    'UghkZXZpY2VJZA==');

@$core.Deprecated('Use deviceDetailsRefPbDescriptor instead')
const DeviceDetailsRefPb$json = {
  '1': 'DeviceDetailsRefPb',
  '2': [
    {'1': 'dbInfoId', '3': 1, '4': 1, '5': 9, '10': 'dbInfoId'},
    {'1': 'deviceOsType', '3': 2, '4': 1, '5': 14, '6': '.proto.DeviceOSTypeEnum', '10': 'deviceOsType'},
    {'1': 'deviceMacId', '3': 3, '4': 1, '5': 9, '10': 'deviceMacId'},
    {'1': 'deviceIpAddress', '3': 4, '4': 1, '5': 11, '6': '.proto.DeviceIpAddress', '10': 'deviceIpAddress'},
    {'1': 'unique_id', '3': 5, '4': 1, '5': 9, '10': 'uniqueId'},
...
/// Descriptor for `DeviceDetailsRefPb`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deviceDetailsRefPbDescriptor = $convert.base64Decode(
    'ChJEZXZpY2VEZXRhaWxzUmVmUGISGgoIZGJJbmZvSWQYASABKAlSCGRiSW5mb0lkEjsKDGRldm'
    'ljZU9zVHlwZRgCIAEoDjIXLnByb3RvLkRldmljZU9TVHlwZUVudW1SDGRldmljZU9zVHlwZRIg'
    'CgtkZXZpY2VNYWNJZBgDIAEoCVILZGV2aWNlTWFjSWQSQAoPZGV2aWNlSXBBZGRyZXNzGAQgAS'
...
const DeviceDetailsSearchReqPb$json = {
  '1': 'DeviceDetailsSearchReqPb',
  '2': [
    {'1': 'deviceOsType', '3': 1, '4': 1, '5': 14, '6': '.proto.DeviceOSTypeEnum', '10': 'deviceOsType'},
  ],
};

/// Descriptor for `DeviceDetailsSearchReqPb`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deviceDetailsSearchReqPbDescriptor = $convert.base64Decode(
    'ChhEZXZpY2VEZXRhaWxzU2VhcmNoUmVxUGISOwoMZGV2aWNlT3NUeXBlGAEgASgOMhcucHJvdG'
    '8uRGV2aWNlT1NUeXBlRW51bVIMZGV2aWNlT3NUeXBl');

@$core.Deprecated('Use deviceDetailsSearchRespPbDescriptor instead')
const DeviceDetailsSearchRespPb$json = {
  '1': 'DeviceDetailsSearchRespPb',
  '2': [
    {'1': 'summary', '3': 1, '4': 1, '5': 11, '6': '.proto.SummaryPb', '10': 'summary'},
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.proto.DeviceDetailsPb', '10': 'results'},
  ],
};

/// Descriptor for `DeviceDetailsSearchRespPb`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deviceDetailsSearchRespPbDescriptor = $convert.base64Decode(
    'ChlEZXZpY2VEZXRhaWxzU2VhcmNoUmVzcFBiEioKB3N1bW1hcnkYASABKAsyEC5wcm90by5TdW'
    '1tYXJ5UGJSB3N1bW1hcnkSMAoHcmVzdWx0cxgCIAMoCzIWLnByb3RvLkRldmljZURldGFpbHNQ'
    'YlIHcmVzdWx0cw==');
