...
import 'package:studence_web/common/appConfig/StudenceAppStateEnumType.dart';
import 'package:studence_web/dataModel/dataHolder.dart';

class StudenceAppStage extends WidgetsBindingObserver {
  final DataHolder<StudenceAppStateEnumType> appState = new DataHolder();
  StudenceAppStage() {
    appState.setListener((data) {
      print(data);
    });
  }

  DataHolder<StudenceAppStateEnumType> get getAppState => appState;
